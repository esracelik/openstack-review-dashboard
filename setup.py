...
#
#     from reviewSearcher import metadata
#
# However, when we do this, we also import `reviewSearcher/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'reviewSearcher_cli = reviewSearcher.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'reviewSearcher_gui = reviewSearcher.gui:entry_point'
        # ]
    }
)
